...
from wtforms import EmailField, PasswordField, SubmitField, BooleanField, StringField, TextAreaField, DateField
...
class PareForm(FlaskForm):
    dateAndTime = DateField('Дата и время', validators=[DataRequired()])
